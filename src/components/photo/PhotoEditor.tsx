    ...
    <div className="fixed inset-0 z-[2100] flex animate-fade-in flex-col bg-background text-foreground">
      ...
      <CommitContext.Provider value={commitDraft}>
        <div className="glass-panel rounded-t-3xl border-t border-border/50 px-3 pb-[calc(env(safe-area-inset-bottom,0px)+0.4rem)] pt-2 pl-safe pr-safe">
          ...
          <div data-gf-ad-blocker className="flex gap-1.5 overflow-x-auto pb-1">
          ...
          {/* Publicité : dernière bande du panneau, sous les outils. Format
              adaptatif (bande basse) : un pavé 300x250 ne tiendrait jamais
              sous la barre d'outils et l'emplacement resterait vide. Elle
              reste hors de la zone d'édition — image, réglages, outils et
              boutons d'action gardent toute leur place — et disparaît
              entièrement quand aucune annonce n'est disponible. */}
          <InlineAdBanner slot="photo-editor" />
        </div>
