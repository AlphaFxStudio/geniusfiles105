...
export function AudioEditor({
  ...
  return (
    <div className="flex h-dvh flex-col bg-background pt-safe">
      ...
      {/* Publicité : dernière bande de l'éditeur, sous la barre d'outils.
          Elle occupe son propre espace et disparaît entièrement quand
          aucune annonce n'est disponible — la timeline, la forme d'onde,
          le transport et les outils gardent toute leur place. */}
      <div className="shrink-0 px-3">
        <InlineAdBanner slot="audio-editor" />
      </div>
