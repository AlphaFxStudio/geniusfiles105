...
/**
 * Descripteurs de LARGEUR (w) plutôt que de densité : les téléphones ont
 * souvent une densité fractionnaire (2,625 / 2,75 / 3,5). Avec des
 * descripteurs `x`, la WebView choisissait une variante trop petite puis
 * l'agrandissait de quelques pourcents sur une grille non entière — c'était
 * la cause du flou visible sur petit téléphone (les tablettes, en densité
 * ×2 exacte, restaient nettes). Avec `w` + `sizes`, la WebView sélectionne
 * toujours une source ≥ au nombre de pixels physiques peints, donc une
 * simple RÉDUCTION : net à toutes les densités.
 */
export const SPLASH_ART_SRCSET =
  "/brand/geniusfiles-splash-1x.png 224w, /brand/geniusfiles-splash-2x.png 448w, /brand/geniusfiles-splash-3x.png 672w, /brand/geniusfiles-splash-4x.png 801w";
 ...
 * 12+, c'est-à-dire la plus grande largeur que le système peut peindre
 * sans rognage ni sur-réduction. Web et natif affichent donc STRICTEMENT
 * la même taille : plus aucun saut d'échelle à la passation. Valeur fixe
 * (jamais relative au viewport), sur téléphone comme sur tablette.
 */
const SPLASH_ART_WIDTH_PX = 192;
/**
 * Hauteur ENTIÈRE (192 × 662/801 ≈ 158,7 → 159). Une hauteur fractionnaire
