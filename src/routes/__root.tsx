...
function RootComponent() {
  ...
  // première page.
  //
  // Le code des écrans principaux est également préchargé au même moment :
  // sans lui, la première ouverture de chaque section devait d'abord aller
  // chercher son morceau de code, ce qui donnait la sensation de « charger
  // une page Web ». Une fois préchargés, ces écrans s'affichent
  // immédiatement.
  useEffect(() => {
    ...
    const off = onStartupReady(() => {
      const run = () => {
        ...
        for (const to of routes) {
          void router.preloadRoute({ to, params: { kind: "images" } }).catch(() => {});
        }
      };
